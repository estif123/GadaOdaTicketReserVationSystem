  ...
  <div class="content-wrapper">
    ...
    <div class="card ">
              <div class="card-header">
                <h3 class="card-title text-primary">  ADD NEW BUS </h3>
              </div>
             
              <form    method="POST" action="addbusreg.php" role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"   name="platenumber" placeholder="Enter Platenumber">
                  </div>
                  <div class="form-group">
                    <label for="sidenumber">Side Number</label>
                    <input type="text" class="form-control"  name="sidenumber" placeholder="Enter side Number">
                  </div>
                  <div class="form-group">
                    <label for="numberofseat">NO Seats</label>
                    <input type="number" class="form-control"  name="seatnumber" placeholder="Enter number of seat">
                  </div>
                  <div class="form-group">
                    <label for="model"> Model</label>
                    <input type="text" class="form-control"  name="busmodel" placeholder="Enter bus model">
                  </div>
                  <div class="form-group">
                    <label for="price"> Price</label>
                    <input type="text" class="form-control"  name="busprice" placeholder="Enter bus Price">
                  </div>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <label>Owner</label>
                      <select name="owner" id="type" class="form-control">
                        <option>Gada</option>
                        <option>Oda</option>                      
                      </select>
                    </div>
