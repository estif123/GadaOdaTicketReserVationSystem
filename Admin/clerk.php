...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Clerks</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="card card-solid">
    <div class="card-body pb-0">
      <div class="row d-flex align-items-stretch">
        ...
        $sql = " SELECT *from account where type='clerk'";
        ...
        <!-- Update Modal -->
        <!-- Modal -->
        <div class="modal fade" id="update_clerk_modal" tabindex="-1" role="dialog" aria-labelledby="UpdateClerkModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="UpdateClerkLabel">Updating Clerk</h5>
...
<script>
  $(function() {
    ...
    $('.btn_update').click(function() {
      var clerkId = $(this).data('id');
      $('#update_clerk_modal').modal('show');
    });

    $('.btn_delete').click(function() {
      var cerkId = $(this).data('id');
