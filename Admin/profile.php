            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#actions" data-toggle="tab">Actons</a></li>
                  <li class="nav-item"><a class="nav-link" href="#activitylogs" data-toggle="tab">Activity Logs</a></li>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="actions">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="../dist/img/avatar3.png" alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header border-0">You delated <a href="#">Sara's account</a> 
                          </h3>
                        </div>
                      </div>
                      <!-- END timeline item -->
